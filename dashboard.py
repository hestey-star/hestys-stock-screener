...
def render_discover():
    ...
    if not current_user.is_logged_in:
        st.markdown(
            ...
            'box-sizing:border-box; }'
            '.discover-hero-btn { font-weight:600; font-size:0.875rem; padding:0.625rem 1.25rem; '
            'border-radius:8px; text-decoration:none; box-sizing:border-box; text-align:center; '
